...
function runEditor()
{
	...
	$(document).off('keydown.editor').on('keydown.editor', function(_e)
	{
		if($(_e.target).is('[data-editor]'))
		{
			if(_e.which === 113 && _e.shiftKey === true)
			{
	...
	$('[data-editor-destroy]').off('click.editor').on('click.editor', function()
	{
		editor.destroy();
...
{
	var editor = new MediumEditor(_el,
	{
		toolbar:
		{
			buttons: ['bold', 'h2', 'h3', 'anchor', 'image', 'quote', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', 'unorderedlist', 'html'],
		},
		autoLink: true,

	});

	$(editor.elements).data('editorObj', editor);
}
