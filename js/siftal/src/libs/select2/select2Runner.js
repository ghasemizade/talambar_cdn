...
function selectRunner()
{
  ...
  $('.select22[data-model="html"]').select22({ templateResult: select22FormatDropDownHtml, templateSelection: select22FormatDropDownHtml, minimumInputLength: 2, maximumInputLength: 20, maximumSelectionSize: 1 });
