...
function selectRunner()
{
  ...
  $('.select22[data-model="html"]').select22({ templateResult: select22FormatDropDownHtml, templateSelection: select22FormatDropDownHtml, delay: 200, minimumInputLength: 1, maximumInputLength: 10, maximumSelectionSize: 1, multiple: true });
