...
{
  console.log('cropper is loaded new');

  $myFile = $('input[type="file"][data-cropper-file]');
  console.log($myFile);
  $myFile.off('change.cropper').on('change.cropper', function(_e){
 ...
 */
function runCropperOld(_args)
{
  console.log('cropper is loaded');
