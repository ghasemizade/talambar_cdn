...
function updateNestedMenuSort()
{
  ...
  mySortable.find('> li').each(function()
  {
    var l1       = $(this);
    var l1_input = l1.find('> .item input');
    var l1_id    = l1_input.attr('data-id');
    l1_input.attr('name', l1_id);

    l1.find('> ol > li').each(function()
    {
      var l2       = $(this);
      var l2_input = l2.find('> .item input');
      var l2_id    = l2_input.attr('data-id');
      l2_input.attr('name', l1_id + '-' + l2_id);

      l2.find('> ol > li').each(function()
      {
        var l3       = $(this);
        var l3_input = l3.find('> .item input');
        var l3_id    = l3_input.attr('data-id');
        l3_input.attr('name', l1_id + '-' + l2_id + '-' + l3_id);
      });
    });
  });
}
