...
function updateNestedMenuSort()
{
  ...
  {
    var l1 = $(this);
    l1.find('> .item input').attr('name', _index1);

    l1.find('> ol > li').each(function(_index2)
    {
      var l2 = $(this);
      l2.find('> .item input').attr('name', _index1 + '-' + _index2);

      l2.find('> ol > li').each(function(_index3)
      {
        var l3 = $(this);
        l3.find('> .item input').attr('name', _index1 + '-' + _index2 + '-' + _index3);

        l3.find('> ol > li').each(function(_index4)
        {
          var l4 = $(this);
          l4.find('> .item input').attr('name', _index1 + '-' + _index2 + '-' + _index3 + '-' + _index4);

          l4.find('> ol > li').each(function(_index5)
          {
            var l5 = $(this);
            l5.find('> .item input').attr('name', _index1 + '-' + _index2 + '-' + _index3 + '-' + _index4 + '-' + _index5);
          });
        });
      });
    });
