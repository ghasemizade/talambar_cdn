...
function runUploader()
{
  ...
  function cropFullScreen(_uploader, _label, _fileInfo, _file)
  {
    ...
    var footer = '<div class="cropRatioChanger mLR5">';
    footer += '<span class="btn mA2" data-ratio="1.7777777777777777" data-ratio2="0.5625">16:9</span>';
    footer += '<span class="btn mA2" data-ratio="1.3333333333333333" data-ratio2="0.75">4:3</span>';
    footer += '<span class="btn mA2" data-ratio="1">1:1</span>';
    footer += '<span class="btn mA2" data-ratio="0.6666666666666666" data-ratio2="1.5">2:3</span>';
    footer += '<span class="btn mA2" data-ratio="1.61803398875" data-ratio2="0.61803398875">Golden Ratio</span>';
    footer += '<span class="btn mA2" data-ratio="NaN">Free</span>';
    footer += '</div>';
    footer += '<div class="cropRotateChanger mLR5">';
    footer += '<span class="btn mA2 sf-undo" data-rotate="90"></span>';
    footer += '<span class="btn mA2 sf-repeat" data-rotate="-90"></span>';
    footer += '</div>';
  ...
  function fillCropperImg(_uploader, _imgSrc)
  {
    ...
    $(document).off('click').on('click', '.cropRatioChanger .btn[data-ratio]', function ()
    {
    ...
    $(document).off('click').on('click', '.cropRotateChanger .btn[data-rotate]', function ()
    {
